...
<body class="sb-nav-fixed">
	...
	<div id="layoutSidenav">
		...
		<div id="layoutSidenav_content">
			<main>
				 <div class="container-fluid px-4" id="loading">
				<h1 class="mt-4">Loading.....</h1>
				</div> 
				<div class="container-fluid px-4" id="content"  style="display: none">
															...
															<div class="modal-content">
																...
																<div class="modal-body">
																	...
																	<form action="<%=request.getContextPath()%>/deleteContent"	method="post">
																		<input type="hidden" name="idDel" value="<%=content.getId()%>">
													...
													<div class="modal-content">
														...
														<div class="modal-body">
															<form method="post"
																...
																<div class="mb-3">
																	<label for="category-film" class="col-form-label">Content:</label> 
																	<input type="text" class="form-control"
																		id="category-film" name="contentsUpdate"
	...
	<%
		...
		int messages = Integer.parseInt(request.getParameter("mgs"));
		String noti = "";
		if (messages == 1) {
